...
from data.dataset import Dataset_GaussianDenoising
from models.image_restoration_model import ImageCleanModel
from utils.utils_noise import load_pretrained_model

parser = argparse.ArgumentParser(description='Gaussian Color Denoising using Restormer')

parser.add_argument(
    '-opt', type=str, default='config/test/test_DudeNet.yml', required=True, help='Path to option YAML file.')
parser.add_argument('--result_dir', default='./results/Gaussian_Color_Denoising/', type=str,
                    help='Directory for results')
parser.add_argument('--weights', default='trans_weights/trans_DudeNet_25.pdparams', type=str, help='Path to weights')
parser.add_argument('--sigmas', default='25', type=str, help='Sigma values')
